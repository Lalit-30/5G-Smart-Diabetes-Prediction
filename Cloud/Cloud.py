...
def runSVM():
    global svm
    global svm_acc     
    svm = sk_svm.SVC(C=2.0,gamma='scale',kernel = 'rbf', random_state = 2) 
...
def runANN():
    global ann
    global ann_acc
    ann = MLPClassifier(solver='lbfgs', alpha=1e-5,hidden_layer_sizes=(5, 2), random_state=1 , max_iter=1000)
...
def start_server():
    ...
    while True:
        ...
        text.insert(END,"Disease Prediction " + result+"\n")
